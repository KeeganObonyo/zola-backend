...
#######################################
Link to the Pricing of the API:
https://mapsplatform.google.com/pricing/?_gl=1*ttdz7j*_ga*Njc1NTQwMjUzLjE3MTM0MzUzNjA.*_ga_NRWSTWS78N*MTcxMzQzNTQyNy4xLjEuMTcxMzQzOTEwOS4wLjAuMA..
#######################################

Now the Question raised and suggestion raised?
Does the cost justify persisting the results?
The cost of persistence outweighs the cost of Maintaining a daily Major midnight cache and continously 
updated at 1hr intervervals while using streaming to get Unique Analytics that Convinces our clients to 
just not pull the API themselves.(Value preposition for the longer road)